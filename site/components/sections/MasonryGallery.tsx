...
export default function MasonryGallery({ items }: { items: GalleryItem[] }) {
  ...
  return (
    <div className="container-luxe">
      {/* Filters */}
      <div className="sticky top-20 z-20 -mx-[var(--gutter)] mb-12 flex flex-wrap gap-2 bg-bone/80 px-[var(--gutter)] py-4 backdrop-blur-md">
        {FILTERS.map((f) => {
          ...
          return (
            <button
              ...
              className={cn(
                "rounded-full border px-5 py-2 text-[0.74rem] font-medium uppercase tracking-[0.14em] transition-colors duration-400",
                on
